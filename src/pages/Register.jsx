      ...
      <div className="card bg-base-100 mx-4 w-full max-w-sm py-5">
        ...
        <form onSubmit={handleRegister} className="card-body">
          <fieldset className="fieldset">
            ...
            <button
              type="submit"
              className="btn bg-pink-500 text-white mt-4 hover:bg-pink-600  transition duration-200 "
            >
              Register
            </button>
        ...
        <button
          ...
          type="button"
          className="btn bg-pink-500 text-white w-10/12 mx-auto hover:bg-pink-600 transition duration-200"
        >
