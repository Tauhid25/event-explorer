...
const ErrorPage = () => {
  return (
    <div className="bg-gray-100 px-6 sm:px-8 lg:px-12 py-12 text-center">
      <Helmet>
        <title>Event Explorer | Error Page</title>
      </Helmet>
      ...
      <p className="font-semibold text-center pt-4 text-xl sm:text-2xl text-gray-600">
